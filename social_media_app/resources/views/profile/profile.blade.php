<x-app-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 flex">
            <!-- Profile Update Section (Left Side) -->
            ...
            <div ng-app="socialApp" ng-controller="PostController" class="w-2/3 sm:px-6 lg:px-8">
                <!-- New Post Form -->
                        ...
                        <div>
                            <div ng-if="post.user_id === currentUserId" class="relative" ng-init="post.showDropdown = false">
                                ...
                                <div ng-if="post.showDropdown" class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
                                    <ul class="py-1">
                                        <li class="px-4 py-2 text-sm text-gray-700 cursor-pointer" ng-click="editPost(post)">Edit</li>
